...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        let athleteArray = ["Eli", "Peyton", "Tom", "Arron", "Colin"]
        defaults.setObject("athleteArray", forKey: "athletes")

        
//        box.putShoe(myshoe)
//        defaults.setObject("atheteArray")
        
// set object = puts shoe in box permanently
//        if checkTheme == nil {
